pipeline {
    ...
    environment {
        ...
        DOCKERHUB_USER = "hassenbn"
        backendimage = "${DOCKERHUB_USER}/emp_backend_k8s"
        frontendimage = "${DOCKERHUB_USER}/emp_frontend_k8s"     
        ...
        GIT_REPO = "https://github.com/hassenbennaceur/employee-management-kubernetes.git"
